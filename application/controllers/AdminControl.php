...
class AdminControl extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Welcome to Website Sistem Pembayaran Air Cluster Andalus';
    ...
    public function myprofile()
    {
        ...
        $this->load->view('template/sidebar', $datacontent, $data);
        $this->load->view('template/topbar', $datacontent, $data);
        $this->load->view('template/admin/myprofile', 1, $datacontent, $data);
        $this->load->view('template/footer');
    }
    ...
    public function daftar_pelanggan()
    {
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/daftar_pelanggan', $datacontent);
        $this->load->view('template/footer');
    }
    ...
    public function pembayaran_manual()
    {
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/pembayaran_manual', $data);
        $this->load->view('template/footer');
    }
    ...
    public function validasi()
    {
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/validasi', $data);
        $this->load->view('template/footer');
    }

    public function pencatatan_kas()
    {
        $session_data = $this->session->userdata('sess_admin');
        $datacontent['session'] = $session_data;
        $data['id'] = $this->AdminModel->get_no_kontrol();
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/pencatatan_kas', $data);
        $this->load->view('template/footer');
    }
    ...
    public function tagihan_bulanan()
    {
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/tagihan_bulanan', $data);
        $this->load->view('template/footer');
    }
    ...
    public function arus_kas()
    {
        ...
        $this->load->view('template/sidebar', $datacontent);
        $this->load->view('template/topbar', $datacontent);
        $this->load->view('template/admin/arus_kas', $data);
        $this->load->view('template/footer');
    }
