	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<div class="box-header">
				<button class="btn btn-primary fa fa-plus" class="glyphicon glyphicon-plus" data-toggle="modal" data-target="#modal-default"> Tambah Pelanggan</button>
			</div><br>
			<?php
				...
				<table class="table table-bordered" id="laporan_keluhan" width="100%">
					<thead>
						<tr>
							...
							<th width="15%">
								<center>Detail Pelanggan</center>
							</th>
							<th width="15%">
								<center>Aksi</center>
							</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" action="<?= base_url() . 'AdminControl/tambah_pelanggan' ?>" method="POST">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1">Nomor Rumah</label>
							<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Nomor Rumah" required>
						</div>
						<div class="form-group">
...
<div class="modal fade bd-example-modal-xl" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Laporan Detail Pelanggan</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			$.ajax({
				...
				success: function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						var btn1 = '<button type="button" name="btn_terima" id="' + data[i]['id_keluhan'] + '" class="btn btn-xs btn-primary btn_kirim" data-toggle="modal" data-target="#BalasModal">Update</button>';
