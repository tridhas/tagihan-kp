<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3" align="center">
            <h4 class="m-0 font-weight-bold text-primary">Validasi Pembayaran Transfer</h4>
        </div>
        <div class="card-body">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var btn1 = '<button type="button" name="btn_kirim" id="' + data[i]['no_kontrol'] + '" class="btn btn-xs btn-primary btn_kirim"></i>Validasi</button>';
                        var btn2 = '<button type="button" name="btn_kirim" id="' + data[i]['no_kontrol'] + '" class="btn btn-xs btn-primary btn_kirim"></i>Lihat</button>';
